    ...
    <div className="min-h-screen flex bg-[#0a0a0f]">
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden border-r border-white/[0.06]">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 -left-24 w-80 h-80 rounded-full bg-primary-600/20 blur-3xl animate-float" />
          <div className="absolute bottom-1/3 right-0 w-96 h-96 rounded-full bg-primary-800/20 blur-3xl animate-float-slow" />
          <div className="absolute top-2/3 left-1/3 w-64 h-64 rounded-full bg-white/[0.03] blur-2xl animate-float-slower" />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div>
            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-4">
              Görevlerinizi
              <br />
              <span className="text-primary-400">bir araya getirin</span>
            </h1>
            <p className="text-white/40 text-lg max-w-md">
              Düzenli kalın, hedeflerinize odaklanın ve işlerinizi kolayca yönetin.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <div className="lg:hidden flex justify-center mb-8">
            <span className="text-white font-black text-lg tracking-tight">GC-TODOLIST</span>
          </div>

          <h2 className="text-2xl font-bold text-white mb-1">Hoş geldiniz</h2>
          <p className="text-white/40 text-sm mb-8">Hesabınıza giriş yapın</p>
